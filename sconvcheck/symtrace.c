...
#include "../include/vki/vki-posixtypes-arm-linux.h"
#include "../include/vki/vki-linux.h"
#include "../include/vki/vki-arm-linux.h"
#include "../include/vki/vki-scnums-arm-linux.h"
...
{
  UInt offset_cur = (HWord)offset;
  UInt lhs_int = (HWord)lhs;
  IRDirty* d1,*d2;
...
*/
	 if(current_addr == 0x480BAEC )
	   {
		argNum = 1;
	   }
	 if(current_addr == 0x480E0E4 )
	   {
		argNum = 2;
	   }
	 if(current_addr == 0x480E2CF )
	   {
		isRealloc = 1;
		argNum = 1;
	   }
