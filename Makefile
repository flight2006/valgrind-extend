...
abs_builddir = /home/wei/valgrind-3.8.1
abs_srcdir = /home/wei/valgrind-3.8.1
abs_top_builddir = /home/wei/valgrind-3.8.1
abs_top_srcdir = /home/wei/valgrind-3.8.1
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/wei/valgrind-3.8.1/install-sh
...
AM_CFLAGS_MIPS32_LINUX =  $(AM_CFLAGS_BASE) -mips32
AM_CCASFLAGS_MIPS32_LINUX =  -mips32 -g
...
regtest: check
	...
	if /bin/perl tests/vg_regtest gdbserver_tests $(TOOLS) $(EXP_TOOLS) ; then \
...
nonexp-regtest: check
	/bin/perl tests/vg_regtest $(TOOLS)
exp-regtest: check
	/bin/perl tests/vg_regtest gdbserver_tests $(EXP_TOOLS)
